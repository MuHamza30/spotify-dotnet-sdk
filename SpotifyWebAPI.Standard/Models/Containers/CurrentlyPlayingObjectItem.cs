// <copyright file="CurrentlyPlayingObjectItem.cs" company="APIMatic">
...
namespace SpotifyWebAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CurrentlyPlayingObjectItem>),
        new Type[] {
    ...
    public abstract class CurrentlyPlayingObjectItem
    {
        ...
        /// </summary>
        /// <returns>
        /// The CurrentlyPlayingObjectItem instance, wrapping the provided TrackObject value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The CurrentlyPlayingObjectItem instance, wrapping the provided EpisodeObject value.
        /// </returns>
        ...
        private sealed class TrackObjectCase : CurrentlyPlayingObjectItem, ICaseValue<TrackObjectCase, TrackObject>
        {
        ...
        private sealed class EpisodeObjectCase : CurrentlyPlayingObjectItem, ICaseValue<EpisodeObjectCase, EpisodeObject>
        {
