// <copyright file="QueueObjectQueue.cs" company="APIMatic">
...
namespace SpotifyWebAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<QueueObjectQueue>),
        new Type[] {
    ...
    public abstract class QueueObjectQueue
    {
        ...
        /// </summary>
        /// <returns>
        /// The QueueObjectQueue instance, wrapping the provided TrackObject value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The QueueObjectQueue instance, wrapping the provided EpisodeObject value.
        /// </returns>
        ...
        private sealed class TrackObjectCase : QueueObjectQueue, ICaseValue<TrackObjectCase, TrackObject>
        {
        ...
        private sealed class EpisodeObjectCase : QueueObjectQueue, ICaseValue<EpisodeObjectCase, EpisodeObject>
        {
